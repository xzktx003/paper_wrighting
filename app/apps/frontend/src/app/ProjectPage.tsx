...
const TagIcon = ({ size = 12 }: { size?: number }) => (
  <svg width={size} height={size} viewBox="0 0 16 16" fill="none" stroke="currentColor" strokeWidth="1.4" strokeLinecap="round" strokeLinejoin="round" style={{ flexShrink: 0, marginRight: 3, verticalAlign: 'middle' }}>
    <path d="M2 8.5l5.3-5.3a1 1 0 01.7-.3H13a1 1 0 011 1v4.8a1 1 0 01-.3.7L8.5 14a1 1 0 01-1.4 0L2 9.9a1 1 0 010-1.4z"/>
                    ...
                    <div className="template-card-body">
                      ...
                      {tpl.tags?.length > 0 && (
                        <div className="template-card-tags">
                          {tpl.tags.map((tag) => <span key={tag} className="project-tag-pill"><TagIcon size={11} />{tag}</span>)}
                        </div>
                      )}
